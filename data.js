...
function cc(archive){return CCAT[archive]||'#8a90a8';}
...
const ITEMS=[
  ...
  /* ════ Phase26: 探索リワード刷新 ════
     ...
     ore=クラフト素材, gold_pile=即Gold, archive_shard=解読で単語発見。 */
...
function equipDisplayName(eq){
  ...
  const rl=(typeof RLBL!=='undefined'&&RLBL[eq.rarity])||eq.rarity||'';
